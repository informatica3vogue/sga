<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
      <ul class="nav nav-tabs nav-stacked main-menu">
        <li><a href="?mod=inicio"><i class="icon-home"></i><span class="hidden-tablet"> Inicio</span></a></li>
        ...
        <li><a href="?mod=repositorio"><i class="icon-folder-open"></i><span class="hidden-tablet"> Repositorio</span></a></li>
         <li>
          <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Administrador</span></a>
          <ul>
            <li><a class="submenu" href="?mod=usuario"><i class="icon-user"></i><span class="hidden-tablet"> Usuarios</span></a></li>
            <li><a class="submenu" href="?mod=dependencia"><i class="icon-file-alt"></i><span class="hidden-tablet"> Secciones</span></a></li>
          </ul> 
        </li>
      </ul>
    </div>
