...
<div class="row-fluid">
    <div class="span6">
        ...
        <div class="row-fluid">
            <div class="box">
                <div class="box-header">
                    <h2><i class="icon-bar-chart white list"></i><span class="break"></span>Actividades finalizadas</h2>
                    <div class="box-icon">
    ...
    <div class="span6">
        <div class="row-fluid">
            <div class="box">
                <div class="box-header">
                    <h2><i class="icon-bar-chart white list"></i><span class="break"></span>Seguimientos generales realizados&nbsp;&nbsp;<label id="refAct"></label></h2>
                    <div class="box-icon">
                        <a href="#" class="btn-minimize" title="Minimizar"><i class="halflings-icon white chevron-up"></i></a>
                    </div>
                </div>
...
function store_actividad(pagina, estado){
    ...
    $.ajax({
        type: 'POST',
        data: parametros,
        url: 'procesos/actividades/store_info_actividad_sup_pendientes.php',
        beforeSend: function () {
...
function busqueda_actividad_pend(txtBuscar) {
    ...
    $.ajax({
        data: parametros,
        url: 'procesos/actividades/buscar_actividad_sup_pendiente.php',
        type: 'POST',
        beforeSend: function () {
            document.getElementById('grid').innerHTML=('<br><br><center><br><p>Cargando datos, espere por favor...</p></center><br><br>');
        },
...
function busqueda_actividad_fin(txtBuscar2) {
    ...
    $.ajax({
        data: parametros,
        url: 'procesos/actividades/buscar_actividad_sup_finalizada.php',
        type: 'POST',
        beforeSend: function () {
...
function store_usuarios_seccion(id_seccion){
    $.post("procesos/actividades/store_usuario_seccion.php", 
