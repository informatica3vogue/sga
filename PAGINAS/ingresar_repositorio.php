<div class="span12">
    <ul class="breadcrumb">
        <a href="?mod=repositorio" class="icon-folder-open " data-toggle='modal' title="Ir a repositorio">&nbsp;Ir a repositorio</a>
    </ul>
    <div class="box">
                ...
                <form action="" role="form" name="frmRepositorio" id="frmRepositorio" enctype="multipart/form-data" autocomplete="off" onsubmit="return false">
                    <div class="panel-body">
                        ...
                        <div id="mostrar">
                            ...
                            <select style="width: 99%;" class="form-group" name="txtPara[]" id="txtPara" multiple="true" data-placeholder="Seleccione usuarios a compartir archivos" data-validation="required" data-validation-error-msg="rellene este campo">
                            </select>
                        </div>
                        <div class="form-group">
