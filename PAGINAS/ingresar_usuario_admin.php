            ...
            <form action="" role="form" name="frmUsuario" id="frmUsuario" enctype="multipart/form-data" autocomplete="off" onsubmit="return false">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_seccion" id="id_seccion" class="form-control select2" data-placeholder="Seleccione una seccion" data-validation="required" data-validation-error-msg="Rellene este campo" style="width: 99.5%;"></select>        
                    </div>
                </div>
