...
$sql = "SELECT * FROM unidad WHERE id_categoria = 2 AND unidad_medida=:txtUnidad AND id_dependencia=:id_dependencia";
...
if ($result['total'] > 0) {
	...
	$sql="INSERT INTO unidad (unidad_medida, id_dependencia, id_categoria) VALUES (:txtUnidad, :id_dependencia, 2)";
