...
$sql = "SELECT * FROM marca WHERE id_categoria = 2 AND marca=:txtMarca AND id_dependencia=:id_dependencia";
...
if ($result['total'] > 0) {
	...
	$sql = "INSERT INTO marca (marca, id_dependencia, id_categoria) VALUES (:txtMarca, :id_dependencia, 2)";
