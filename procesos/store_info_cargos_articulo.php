...
if(isset($params)) {  
    ...
    $sql = "SELECT articulo.articulo, articulo.existencia, marca.marca FROM articulo INNER JOIN categoria ON categoria.id_categoria = articulo.id_categoria INNER JOIN marca ON marca.id_marca = articulo.id_marca  WHERE articulo.id_dependencia = :id_dependencia AND categoria.id_categoria=1 ORDER BY existencia ASC";
