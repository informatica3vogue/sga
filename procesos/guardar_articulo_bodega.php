...
if(isset($params["txtId"])){
	...
	$sql="INSERT INTO articulo( articulo, descripcion, existencia, id_marca, id_linea, id_unidad, id_categoria, id_dependencia, fecha_procesamiento) VALUES (:txtArticulo, :txtDescripcion, 0, :txtMarcas, :txtLineas, :txtUnidades, 2, :id_dependencia, NOW())";
