...
if(isset($params)) {  
    ...
    $sql = "SELECT id_articulo, articulo FROM articulo INNER JOIN categoria c ON articulo.id_categoria = c.id_categoria WHERE existencia > 0 AND c.id_categoria = 1 ORDER BY articulo ASC";
