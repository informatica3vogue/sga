...
$sql = "SELECT id_memorandum, tipo_memorandum, referencia, fecha_creacion, de, para, asunto, descripcion, con_copia FROM memorandum WHERE id_usuario=:id_usuario AND tipo_memorandum='Externo' AND id_dependencia=:id_dependencia ORDER BY fecha_creacion DESC LIMIT :start, :limit";
...
if ($response["total"] > 0) {
    ...
    $sql = "SELECT * FROM memorandum WHERE id_usuario=:id_usuario AND tipo_memorandum='Externo'";
