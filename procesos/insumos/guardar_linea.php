...
$sql = "SELECT * FROM linea WHERE id_categoria = 1 AND linea=:txtLinea AND id_dependencia=:id_dependencia";
...
if ($result['total'] > 0) {
	...
	$sql="INSERT INTO linea (linea, id_dependencia, id_categoria) VALUES (:txtLinea, :id_dependencia, 1)";
