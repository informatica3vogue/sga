...
$sql = "INSERT INTO cargos(fecha, cantidad, referencia, observacion, id_dependencia, id_usuario, id_articulo)  VALUES (NOW(), :txtCantidad, :txtReferecia, :txObservacion, :id_dependencia, :id_usuario, :txtArticulo)";
