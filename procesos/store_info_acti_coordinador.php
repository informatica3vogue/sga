...
if ($response["total"] > 0) {
        ...
        <table class='table table-hover table-bordered table-condensed' style='font-size: 9pt;'>
            <thead>
                <tr>
                    <th>Acciones</th>
                    <th>Referencia</th>
                    <th width=30px>Fecha de Procesamiento</th>
                    <th width=30px>Fecha de Solicitud</th>
                    <th>Dependencia</th>
                    <th>Solicitante</th>
                    <th>Requerimiento</th>
                    <th>Asignados</th>
    ...
    $sql = "SELECT DISTINCT * FROM actividad INNER JOIN asignacion ON actividad.id_actividad = asignacion.id_actividad WHERE asignacion.id_usuario = :id_usuario";
