...
$param=array('id');
 $sql = "SELECT me.id_memorandum,me.fecha_creacion,me.referencia,me.asunto,me.para,me.de,me.tipo_memorandum,me.descripcion,me.con_copia,us.nombre FROM memorandum me INNER JOIN usuario us ON us.id_usuario = me.id_usuario WHERE me.tipo_memorandum=:tipo_memorandum ORDER BY fecha_creacion";

    $param_list=array('tipo_memorandum');
