...
$param=array('id');
 $sql = "SELECT id_memorandum,fecha_creacion,referencia,asunto,para,de,tipo_memorandum,descripcion,con_copia FROM memorandum WHERE fecha_creacion BETWEEN  :txtDesdeD AND  DATE_ADD(:txtHastaD, INTERVAL 1 DAY) ORDER BY fecha_creacion desc";

    $param_list=array('txtDesdeD', 'txtHastaD');
...
<tr><td>Reporte de memorándum por: '.$text.'</td></tr>
</table><hr></header>';
